...
var parseNestedQuery = __webpack_require__(9);
...
var getFormFields = __webpack_require__(4);
var gameCrud = __webpack_require__(14);
var gameUi = __webpack_require__(15);

var onNewGame = function onNewGame(event) {
  // const data = getFormFields(this)
  event.preventDefault();
  gameCrud.newGame().then(gameUi.newGameSuccess).catch(gameUi.newGameFailure);
};
...
var onUpdateGame = function onUpdateGame(event) {
  ...
  var data = getFormFields(this);
  gameCrud.updateGame(data).then(gameUi.updateGameSuccess).catch(gameUi.updateGameFailure);
};

var onAllGames = function onAllGames(event) {
  event.preventDefault();
  // gameCrud.index()
...
var allGamesSuccess = function allGamesSuccess(data) {
  var allGames = data.games.lenght;
  $('').text('You have played ' + allGames + ' finished games');
  // console.log('changePassword success ran. and nothing was returned')
};

var allGamesFailure = function allGamesFailure() {
...
module.exports = {
  ...
  allGamesSuccess: allGamesSuccess,
  allGamesFailure: allGamesFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var checkWinner = function checkWinner() {
  ...
  game.board[0] === game.player.currentPlayer && game.board[3] === game.player.currentPlayer && game.board[6] === game.player.currentPlayer || game.board[1] === game.player.currentPlayer && game.board[4] === game.player.currentPlayer && game.board[7] === game.player.currentPlayer || game.board[2] === game.player.currentPlayer && game.board[5] === game.player.currentPlayer && game.board[8] === game.player.currentPlayer ||
  // check for horizontal wins
  game.board[0] === game.player.currentPlayer && game.board[1] === game.player.currentPlayer && game.board[2] === game.player.currentPlayer || game.board[3] === game.player.currentPlayer && game.board[4] === game.player.currentPlayer && game.board[5] === game.player.currentPlayer || game.board[6] === game.player.currentPlayer && game.board[7] === game.player.currentPlayer && game.board[8] === game.player.currentPlayer ||
  // check for diagonal wins
  game.board[0] === game.player.currentPlayer && game.board[4] === game.player.currentPlayer && game.board[8] === game.player.currentPlayer || game.board[2] === game.player.currentPlayer && game.board[4] === game.player.currentPlayer && game.board[6] === game.player.currentPlayer) {
    game.over = true;
